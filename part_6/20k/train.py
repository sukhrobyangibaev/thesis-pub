...
df = pd.read_csv('part_6/19662x158_samples.csv')
...
# --------------------------------
with open('trained_models/et_classifier.pkl', 'wb') as f:
    pickle.dump(et_classifier, f)
with open('trained_models/gb_classifier.pkl', 'wb') as f:
    pickle.dump(gb_classifier, f)
with open('trained_models/hgb_classifier.pkl', 'wb') as f:
    pickle.dump(hgb_classifier, f)
with open('trained_models/rf_classifier.pkl', 'wb') as f:
    pickle.dump(rf_classifier, f)
with open('trained_models/ab_classifier.pkl', 'wb') as f:
