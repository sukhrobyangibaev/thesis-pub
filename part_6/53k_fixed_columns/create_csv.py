...
for entry in matches:
    try:
        ...
        tmp['radiant_tower_state'] = entry["scoreboard"]['radiant']["tower_state"]
        tmp['dire_tower_state'] = entry["scoreboard"]['dire']["tower_state"]

        tmp['radiant_barracks_state'] = entry["scoreboard"]['radiant']["barracks_state"]
        tmp['dire_barracks_state'] = entry["scoreboard"]['dire']["barracks_state"]
...
df.to_csv(f'part_6/53k_fixed_columns/{df.shape[0]}x{df.shape[1]}_samples.csv', index=False)