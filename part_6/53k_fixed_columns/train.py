...
# acc_avg += result['accuracy_score']
# print('Gradient Boosting', result['accuracy_score'])
# result['classifier'] = 'Gradient Boosting'
# results.append(result)

# with open('part_6/53k_xp_per_min/gb_classifier.pkl', 'wb') as f:
...
# with open('part_6/53k_xp_per_min/hgb_classifier.pkl', 'wb') as f:
...
# with open('part_6/53k_xp_per_min/ab_classifier.pkl', 'wb') as f:
