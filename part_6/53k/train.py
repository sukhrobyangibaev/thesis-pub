...
df = pd.read_csv('part_6/53k/53169x158_samples.csv')
...
with open('part_6/53k/et_classifier.pkl', 'wb') as f:
...
with open('part_6/53k/gb_classifier.pkl', 'wb') as f:
...
with open('part_6/53k/hgb_classifier.pkl', 'wb') as f:
...
with open('part_6/53k/rf_classifier.pkl', 'wb') as f:
...
with open('part_6/53k/ab_classifier.pkl', 'wb') as f:
