...
df = pd.read_csv('part_6/53k_fixed_columns/53169x156_samples.csv')
...
with open('part_6/53k_fixed_columns/cart_classifier.pkl', 'wb') as f:
...
with open('part_6/53k_fixed_columns/c4.5_classifier.pkl', 'wb') as f:
...
with open('part_6/53k_fixed_columns/et_classifier.pkl', 'wb') as f:
...
with open('part_6/53k_fixed_columns/gb_classifier.pkl', 'wb') as f:
...
with open('part_6/53k_fixed_columns/hgb_classifier.pkl', 'wb') as f:
...
with open('part_6/53k_fixed_columns/rf_classifier.pkl', 'wb') as f:
...
with open('part_6/53k_fixed_columns/ab_classifier.pkl', 'wb') as f:
