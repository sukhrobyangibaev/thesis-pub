...
for i_f, filename in enumerate(filenames):
    ...
    df = pd.read_csv(f'part_9_embedding/new/{filename}')
    ...
    with open(f'part_9_embedding/trained_models/{foldernames[i_f]}/cart_classifier.pkl', 'wb') as f:
    ...
    with open(f'part_9_embedding/trained_models/{foldernames[i_f]}/c4.5_classifier.pkl', 'wb') as f:
    ...
    with open(f'part_9_embedding/trained_models/{foldernames[i_f]}/et_classifier.pkl', 'wb') as f:
    ...
    with open(f'part_9_embedding/trained_models/{foldernames[i_f]}/gb_classifier.pkl', 'wb') as f:
    ...
    with open(f'part_9_embedding/trained_models/{foldernames[i_f]}/hgb_classifier.pkl', 'wb') as f:
    ...
    with open(f'part_9_embedding/trained_models/{foldernames[i_f]}/rf_classifier.pkl', 'wb') as f:
    ...
    with open(f'part_9_embedding/trained_models/{foldernames[i_f]}/ab_classifier.pkl', 'wb') as f:
        pickle.dump(ab_classifier, f)

    # with open(f'part_9_embedding/new/results.txt', 'a') as f:
