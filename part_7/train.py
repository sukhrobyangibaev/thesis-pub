...
with open('part_7/30min/cart_classifier.pkl', 'wb') as f:
...
with open('part_7/30min/c4.5_classifier.pkl', 'wb') as f:
...
with open('part_7/30min/et_classifier.pkl', 'wb') as f:
...
with open('part_7/30min/gb_classifier.pkl', 'wb') as f:
...
with open('part_7/30min/hgb_classifier.pkl', 'wb') as f:
...
with open('part_7/30min/rf_classifier.pkl', 'wb') as f:
...
with open('part_7/30min/ab_classifier.pkl', 'wb') as f:
